      ...
      <div>
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
            <div className="container-fluid">
                <a className="navbar-brand" href="_blank">NewsDog</a>
                ...
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a className="dropdown-item" href="_blank">Action</a></li>
                        <li><a className="dropdown-item" href="_blank">Another action</a></li>
                        <li><hr className="dropdown-divider"></hr></li>
                        <li><a className="dropdown-item" href="_blank">Something else here</a></li>
                    </ul>
                    </li>
